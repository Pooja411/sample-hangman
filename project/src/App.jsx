...
import stage1 from './assets/ABC.jpeg'
import stage2 from './assets/ABC.jpeg'
import stage3 from './assets/ABC.jpeg'
import stage4 from './assets/ABC.jpeg'
import stage5 from './assets/ABC.jpeg'
import stage6 from './assets/ABC.jpeg'
import stage7 from './assets/ABC.jpeg'
import './App.css'
    ...
    <div className="game-container">
      ...
      <AnimatePresence>
        {gameStatus !== 'playing' && (
          ...
          >
            <h2>{gameStatus === 'won' ? 'Congratulations! You got it right!' : 'Game Over!'}</h2>
            {gameStatus === 'lost' && (
              <p>The correct command was: <code>{currentQuestion?.answer}</code></p>
            )}
            <motion.button 
              onClick={resetGame} 
